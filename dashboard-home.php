  ...
  <div class="modules-section">
    <div class="container">
      <div class="modules-grid">
        ...
        <!-- Module 1: SHOP -->
        <a href="view/frontoffice/login_admin.php" class="module-card module-shop">
        ...
        <!-- Module 2: FEED -->
        <a href="view/frontoffice/login_admin.php" class="module-card module-feed">
        ...
        <!-- Module 3: TUTORIALS -->
        <a href="view/frontoffice/login_admin.php" class="module-card module-tutorials">
          <span class="status-badge status-soon">
            <i class="fa fa-clock"></i> Coming Soon
          </span>
          <div class="module-icon">
        ...
        <!-- Module 4: EVENTS -->
        <a href="view/frontoffice/login_admin.php" class="module-card module-events">
          <span class="status-badge status-soon">
            <i class="fa fa-clock"></i> Coming Soon
          </span>
          <div class="module-icon">
        ...
        <!-- Module 5: QUIZS -->
        <a href="view/frontoffice/login_admin.php" class="module-card module-quizs">
          <span class="status-badge status-soon">
            <i class="fa fa-clock"></i> Coming Soon
          </span>
          <div class="module-icon">
        ...
        <!-- Module 6: USERS -->
        <a href="view/frontoffice/login_admin.php" class="module-card module-login">
          <span class="status-badge status-active">
            <i class="fa fa-check-circle"></i> Active
          </span>
          <div class="module-icon">
