...
require_once __DIR__ . '/../model/Like.php';   // JSON Like Model
require_once __DIR__ . '/../model/Share.php';  // JSON Share Model (NEW)
...
foreach ($latestPosts as &$post) {
    ...
    $post['shares'] = $shareModel->getPostShares($post['id']);
        ...
        // ======================================================
        ob_start();
        include __DIR__ . '/../view/dashboard/index-community.php';
