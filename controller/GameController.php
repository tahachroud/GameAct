...
class GameController {
    ...
    public function showShop(): void {
        try {
            ...
            require_once __DIR__ . '/../view/frontoffice/shop.php';
        } catch (Exception $e) {
    ...
    public function showAllGames(): void {
        try {
            $games = $this->gameModel->getAllGames();
            require_once __DIR__ . '/../view/frontoffice/all-games.php';
        } catch (Exception $e) {
    ...
    public function showGameDetails(): void {
        try {
            ...
            require_once __DIR__ . '/../view/frontoffice/details.php';
        } catch (Exception $e) {
    ...
    public function searchGamesView(): void {
        try {
            ...
            require_once __DIR__ . '/../view/frontoffice/search-results.php';
        } catch (Exception $e) {
    ...
    public function filterByCategory(): void {
        try {
            ...
            require_once __DIR__ . '/../view/frontoffice/category-games.php';
        } catch (Exception $e) {
    ...
    public function showGamesList(): void {
        try {
            $games = $this->gameModel->getAllGames();
            require_once __DIR__ . '/../view/backoffice/games-list.php';
        } catch (Exception $e) {
    ...
    public function showAddGameForm(): void {
        require_once __DIR__ . '/../view/backoffice/add-game.php';
    }
    ...
    public function showEditGameForm(): void {
        try {
            ...
            require_once __DIR__ . '/../view/backoffice/edit-game.php';
        } catch (Exception $e) {
    ...
    private function handleImageUpload(?array $file, string $defaultPath = ''): string {
        ...
        $uploadDir = __DIR__ . '/../view/assets/images/games/';
        if (!is_dir($uploadDir)) {
    ...
    private function handleVideoUpload(?array $file, string $defaultPath = ''): string {
        ...
        $uploadDir = __DIR__ . '/../view/assets/videos/';
        if (!is_dir($uploadDir)) {
            mkdir($uploadDir, 0777, true);
        }
    ...
    private function handleZipUpload(?array $file, string $defaultPath = ''): string {
        ...
        $uploadDir = __DIR__ . '/../view/assets/games/';
        if (!is_dir($uploadDir)) {
            mkdir($uploadDir, 0777, true);
        }
    ...
    private function deleteFile(?string $filePath): void {
        if (!empty($filePath)) {
            $fullPath = __DIR__ . '/../view/' . $filePath;
    ...
    public function showCart(): void {
        try {
            ...
            require_once __DIR__ . '/../view/frontoffice/cart.php';
        } catch (Exception $e) {
