            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            <li><a href="index.php?page=quiz_list" class="<?php echo ($page ?? '') == 'quiz_list' ? 'active' : ''; ?>">Quiz</a></li>
                            <li><a href="index.php?page=quiz_create" class="<?php echo ($page ?? '') == 'quiz_create' ? 'active' : ''; ?>">Create Quiz</a></li>
                            <li><a href="index.php?page=user_my_quizzes" class="<?php echo ($page ?? '') == 'user_my_quizzes' ? 'active' : ''; ?>">My Quizzes</a></li>
