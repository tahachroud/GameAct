                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="main-border-button" style="padding: 30px; background: #27292a; border-radius: 15px;">
                            ...
                            <form action="index.php?page=user_update_quiz" method="POST" enctype="multipart/form-data" id="edit-quiz-form">
                                ...
                                <div style="margin-top: 40px; text-align: center; border-top: 2px solid #444; padding-top: 30px;">
                                    ...
                                    <a href="index.php?page=user_my_quizzes" class="btn btn-secondary" style="padding: 15px 40px; font-size: 18px; font-weight: 600; border-radius: 10px;">
