        ...
        <div class="col-lg-12">
            <div class="page-content">
                ...
                <div class="create-quiz-container">
                    ...
                    <form method="POST" action="index.php?page=quiz_create" id="create-quiz-form" enctype="multipart/form-data">
                        ...
                        <div style="text-align: center; margin-top: 40px; padding-top: 30px; border-top: 2px solid #333;">
                            ...
                            <a href="index.php?page=quiz_list" class="btn-cancel" style="margin-left: 20px;">
