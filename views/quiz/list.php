                        ...
                        <div class="col-lg-7">
                            <div class="header-text">
                                ...
                                <div class="main-button">
                                    <a href="index.php?page=quiz_create" class="create-quiz-btn">
                                ...
                                <?php else: ?>
                                    <?php foreach($quizzes as $quiz): ?>
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="quiz-card" onclick="window.location.href='index.php?page=quiz_play&id=<?php echo $quiz['id_quiz']; ?>'">
...
function updateStatistics() {
    fetch('index.php?page=get_user_stats')
