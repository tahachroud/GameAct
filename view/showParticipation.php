...
// Créer une instance de ParticipationC
...
<head>
  ...
  <title>Détails Participation · GameAct Admin</title>
  ...
  <main class="app-main">
    <div class="container-fluid">
      <div class="d-flex justify-between align-center mb-4">
        <h1 class="h3">Détails de la participation</h1>
      ...
      <div class="card">
        <div class="mb-4">
          <h3>Participation #<?= htmlspecialchars($participation['idP']); ?></h3>
          <span class="btn btn-info btn-sm"><?= htmlspecialchars($participation['statutP']); ?></span>
        </div>

        <div class="row g-3">
          <div class="col-md-6">
            <div class="mb-3">
              <label class="form-label">ID Participation</label>
              <div class="form-control" style="background: var(--gray); border: 1px solid var(--border);"><?= htmlspecialchars($participation['idP']); ?></div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <div class="form-control" style="background: var(--gray); border: 1px solid var(--border);"><?= htmlspecialchars($participation['nomP']); ?></div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <div class="form-control" style="background: var(--gray); border: 1px solid var(--border);"><?= htmlspecialchars($participation['emailP']); ?></div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <div class="form-control" style="background: var(--gray); border: 1px solid var(--border);"><?= htmlspecialchars($participation['id']); ?></div>
            </div>
          </div>

          <div class="col-12">
            <div class="mb-3">
              <label class="form-label">Remarque (Détails)</label>
              <div class="form-control" style="background: var(--gray); border: 1px solid var(--border); min-height: 100px;"><?= htmlspecialchars($participation['remarqueP']); ?></div>
            </div>
          </div>
        </div>

        <div class="action-buttons">
          <!-- <a href="updateParticipation.php?idP=<?= $participation['idP']; ?>" class="btn btn-warning">
