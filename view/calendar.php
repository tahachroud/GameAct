...
<head>
  ...
  <title>Calendrier · GameAct Admin</title>
...
<body>
  ...
  <aside class="app-sidebar" id="sidebar">
    ...
    <nav class="nav-sidebar">
      ...
      <a href="calendar.php" class="nav-link active"><i class="fas fa-calendar-alt"></i> Calendrier</a>
  ...
  <main class="app-main">
    <div class="container-fluid">
      ...
      <div class="d-flex justify-between align-items-center mb-4">
        ...
        <a href="addEventForm.php" class="btn btn-primary">
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        dateClick: function(info) {
          window.location.href = 'addEventForm.php?date=' + info.dateStr;
        },
        height: 'auto',
        eventTimeFormat: {
          hour: '2-digit',
