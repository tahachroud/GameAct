...
<head>
    ...
    <title><?php echo $pageTitle ?? 'Admin Panel - Gaming Quiz'; ?></title>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <div class="search-input">
                            <span style="color: #e84057; font-weight: 600;">
                                <i class="fa fa-shield"></i> ADMIN PANEL
                            </span>
                        </div>
                        <ul class="nav">
                            <li><a href="admin.php?page=dashboard" class="<?php echo ($page ?? '') == 'admin_dashboard' ? 'active' : ''; ?>">Dashboard</a></li>
                            <li><a href="admin.php?page=quiz_manage" class="<?php echo ($page ?? '') == 'admin_quiz_manage' ? 'active' : ''; ?>">Manage Quiz</a></li>
                            <li><a href="quiz_list.php?page=quiz_list">Back to Site</a></li>
                            <li><a href="#">Admin <img src="assets/images/profile-header.jpg" alt=""></a></li>
                        </ul>   
