...
$featuredGames = $gameController->getTopRatedGames(6); // Top 6 jeux
...
<head>
  ...
  <link rel="stylesheet" href="views/assets/css/templatemo-cyborg-gaming.css">
  ...
  <style>
    ...
    .hero-section::before {
      ...
      right: 0;
      bottom: 0;
      background: url('views/assets/images/banner-bg.jpg') center/cover;
      opacity: 0.1;
    }
    .hero-content {
      position: relative;
...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            <a href="index.php" class="logo">
              <img src="views/assets/images/logo.png" alt="GameAct">
            </a>
            <div class="search-input">
              <form id="search" action="views/frontoffice/all-games.php" method="GET">
            ...
            <ul class="nav">
              ...
              <li><a href="views/frontoffice/shop.php">Shop</a></li>
              <li><a href="views/frontoffice/all-games.php">Browse Games</a></li>
              <li><a href="views/backoffice/dashboard_shop.php">Admin</a></li>
              <li>
                <a href="views/frontoffice/favorites.php">
      ...
      <div class="row align-items-center">
        <div class="col-lg-7">
          <div class="hero-content">
            ...
            <a href="views/frontoffice/shop.php" class="btn-hero">
              <i class="fa fa-shopping-bag"></i> Explore Shop
            </a>
            <a href="views/frontoffice/all-games.php" class="btn-hero-secondary">
              <i class="fa fa-gamepad"></i> Browse Games
            </a>
          </div>
        </div>
        <div class="col-lg-5 text-center d-none d-lg-block">
          <img src="views/assets/images/banner-right-image.png" alt="Gaming" style="max-width: 100%; filter: drop-shadow(0 10px 30px rgba(236,96,144,0.5));">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <?php foreach ($popularCategories as $category): ?>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <a href="views/frontoffice/all-games.php?category=<?= urlencode($category['name']) ?>" style="text-decoration: none;">
  ...
  <div class="container mt-5">
    ...
    <div class="row">
      <?php foreach ($featuredGames as $game): ?>
        <div class="col-lg-4 col-md-6 mb-4">
          <a href="views/frontoffice/details.php?id=<?= $game['id'] ?>" style="text-decoration: none;">
            <div class="game-card">
              <img src="views/<?= htmlspecialchars($game['image_path']) ?>" alt="<?= htmlspecialchars($game['title']) ?>">
    ...
    <div class="text-center mt-4">
      <a href="views/frontoffice/all-games.php" class="btn btn-outline-light btn-lg px-5">
  ...
  <div class="container">
    <div class="cta-section">
      ...
      <a href="views/frontoffice/shop.php" class="btn btn-light btn-lg px-5" style="font-weight: 700;">
