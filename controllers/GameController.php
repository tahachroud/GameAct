...
class GameController {
    ...
    public function addGameProcess(): void {
        try {
            ...
            $zipPath = $this->handleZipUpload($_FILES['zip_file'] ?? null);
            $game->setZipFilePath($zipPath);
    ...
    public function updateGameProcess(): void {
        try {
            ...
            $zipPath = $this->handleZipUpload($_FILES['zip_file'] ?? null, $existingGame['zip_file_path']);
            $game->setZipFilePath($zipPath);
    ...
    public function deleteGameProcess(): void {
        try {
            ...
            if ($game) {
                ...
                $this->deleteFile($game['zip_file_path']);
            }
